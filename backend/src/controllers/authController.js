...
const login = async (req, res) => {
    try {
        ...
        const users = await query(
            'SELECT id, username, email, password_hash, full_name, role, is_active FROM users WHERE username = ? AND is_active = TRUE',
            [username]
        );
        ...
        console.log("Hash do banco de dados:", user.password_hash);
